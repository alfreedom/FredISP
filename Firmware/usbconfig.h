 ...
 */
 #define USB_CFG_VENDOR_NAME     'F', 'r', 'e', 'd', ' ', 'L', 'a', 'b', 's' 
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'F', 'r', 'e', 'd', 'I', 'S', 'P', '-', 'U', 'S', 'B', 'T', 'i', 'n', 'y'
 ...
 */
#define VENDOR 'F','L'
#define PRODUCT	'F','I','S','P'
#define YEAR	'1','8'
//#define PROD_NUMBER	'0','0','0','0'
#define VERSION	'1','0'

#define USB_CFG_SERIAL_NUMBER VENDOR, YEAR, PRODUCT, VERSION, PROD_NUMBER
#define USB_CFG_SERIAL_NUMBER_LEN   14
